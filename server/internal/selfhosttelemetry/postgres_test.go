...
func TestTelemetryMigrationsUpAndDown(t *testing.T) {
	...
	up := []string{
		"461_instance_telemetry_state.up.sql",
		"462_instance_telemetry_state_singleton_index.up.sql",
		"463_instance_telemetry_state_primary_key.up.sql",
		"464_agent_runtime_telemetry_last_seen_index.up.sql",
		"465_agent_task_queue_telemetry_started_index.up.sql",
	}
	for _, name := range up {
	...
	down := []string{
		"465_agent_task_queue_telemetry_started_index.down.sql",
		"464_agent_runtime_telemetry_last_seen_index.down.sql",
		"463_instance_telemetry_state_primary_key.down.sql",
		"462_instance_telemetry_state_singleton_index.down.sql",
		"461_instance_telemetry_state.down.sql",
	}
